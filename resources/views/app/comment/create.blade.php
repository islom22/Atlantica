...
@section('content')
    ...
    <h1 class="text-uppercase mt-5">Comment</h1>

    <div class="headcrumbs d-flex mb-3">
        <a href="{{ route('comments.index') }}" class="d-flex text-uppercase me-2" style="opacity:25%">Comment</a> >> <a class="d-flex text-uppercase ms-2">Add </a>
    </div>
